...
class Config:
    ...
    MAVERICK_HURDLE_MULTIPLIER = 1.0  # Multiplier for hurdle rate in maverick mode (1.25x = higher hurdle)
    ...
    COMMITTEE_QUORUM = 1  # Number of committee members required to agree for a trade
    ...
    CONVICTION_COEFFICIENT_FLOOR = 0.5  # Minimum coefficient for conviction threshold calculation (allows sub-threshold conviction)
