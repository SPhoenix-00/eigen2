...
class Config:
    ...
    COMMITTEE_QUORUM = 4  # Number of committee members required to agree for a trade (coeff >= COEFFICIENT_THRESHOLD)
    MAVERICK_CONVICTION_PERCENTILE_FLOOR = 99.9  # Minimum conviction percentile for maverick agents
