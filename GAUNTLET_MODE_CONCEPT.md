...
- Step 3: The Gauntlet (The Test)
    ...
    - Scoring: We use an aggregator (0.67*mean + 0.33*min, excluding top slice) to balance robustness with average performance while preventing lucky outliers from inflating the score
